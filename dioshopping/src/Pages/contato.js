...
const Contatos = () => {
    ...
    return(
        <>
            <Grid container direction="column" justifyContent="center" alignItems="center" className='card' xs={12}>
                ...
                <Button onClick={sendMessage} className="mt-2 mb-3" variant="contained" color="primary">
                    Enviar
                </Button>
            </Grid>
